...
*/
    ...
    const generalPause = () => {
        handleGeneralPause();
        api.post('/presses_general_pause/').catch(error => {
    ...
    const generalFailure = () => {
        ...
        api.post('/presses_general_failure/').catch(error => {
        ...
        <div className=' lg:p-2'>
            <div className='flex flex-wrap items-center justify-center'>
                ...
                <div className='flex items-end gap-1 absolute right-0 mr-2'>
                    <button
                        className='rounded-sm text-white p-2 bg-[#E1CD1C] text-xs sm:text-sm md:text-base md:text-md lg:text-xl xl:text-xl'
                    ...
                    <button
                        className='rounded-sm text-white p-2 bg-[#EF3333] text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl'
