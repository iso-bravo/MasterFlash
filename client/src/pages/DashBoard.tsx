...
import { AnualProduction, scrapData, WeekProduction } from '../types/DashBoardTypes';
...
const DashBoard = () => {
  ...
  // const fakeData: AnualProduction[] = [
  //   { month: 'January', goal: 1000, pieces_ok: 900 },
  //   { month: 'February', goal: 1100, pieces_ok: 1050 },
  //   { month: 'March', goal: 1200, pieces_ok: 1150 },
  //   { month: 'April', goal: 1300, pieces_ok: 1250 },
  //   { month: 'May', goal: 1250, pieces_ok: 1100 },
  //   { month: 'June', goal: 1400, pieces_ok: 1350 },
  //   { month: 'July', goal: 1500, pieces_ok: 1400 },
  //   { month: 'August', goal: 1600, pieces_ok: 1500 },
  //   { month: 'September', goal: 1550, pieces_ok: 1450 },
  //   { month: 'October', goal: 1650, pieces_ok: 1600 },
  //   { month: 'November', goal: 1700, pieces_ok: 1650 },
  //   { month: 'December', goal: 1750, pieces_ok: 1700 },
  // ];
