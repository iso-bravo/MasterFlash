              ...
              <div key={index} className="flex flex-row items-center">
                ...
                {input === "No. Parte" ? (
                  <>
                    ...
                    />
                    <button onClick={handleSearchPartNumber} className=" text-sm ml-2 px-2 py-1 bg-[#579fdd] rounded-sm">
                      Buscar
                    </button>
                  </>
                ) : input === "Metal" ? (
                  <>
                    <input
                      ...
                      className="w-40 rounded-sm h-6"
                    />
                    <button onClick={handleSearchMetal} className=" text-sm ml-2 px-2 py-1 bg-[#579fdd] rounded-sm">
                      Buscar
                    </button>
                  </>
                ) : (
