...
const LabelsCavitiesForm: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4 grid grid-cols-2 gap-4'>
            ...
            <button
                className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center col-span-2'
                type='submit'
            >
                Next
            </button>
