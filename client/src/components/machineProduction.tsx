...
const MachineProduction: React.FC<MachineProps> = ({ machineData, onClick, selectedState }) => {
    ...
    return (
        <div
            className={`flex flex-row p-4 m-2 gap-2 rounded-md text-white ${backgroundColorClass} w-4/5 min-w-[16rem] max-w-[20rem] sm:max-w-[20rem] md:max-w-[23rem] lg:min-w-[20rem] lg:max-w-[24rem] xl:max-w-[27rem] cursor-pointer`}
            onClick={onClick}
        >
            <div className=' w-2/3'>
                ...
                <div className='flex gap-2 text-md items-center'>
                    ...
                    <p className='mt-3 text-xl sm:text-xl md:text-2xl lg:text-2xl font-semibold'>
